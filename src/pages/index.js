        ...
        <ul classname="sns">
          <li>
            <a href="https://twitter.com/">
              ...
              </i></a><i classname="fab fa-twitter">
            </i></li><i classname="fab fa-twitter">
            <li>
              <a href="https://facebook.com/">
                <i classname="fab fa-facebook-square">
                  <span classname="sr-only">Facebook</span>
                </i></a><i classname="fab fa-facebook-square">
              </i></li><i classname="fab fa-facebook-square">
              <li>
                <a href="http://instagram.com/">
                  <i classname="fab fa-instagram">
                    <span classname="sr-only">Instagram</span>
                  </i></a><i classname="fab fa-instagram">
                </i></li><i classname="fab fa-instagram">
              </i></i></i></ul><i classname="fab fa-twitter"><i classname="fab fa-facebook-square"><i classname="fab fa-instagram">
            </i></i></i></div><i classname="fab fa-twitter"><i classname="fab fa-facebook-square"><i classname="fab fa-instagram">
          </i></i></i></footer><i classname="fab fa-twitter"><i classname="fab fa-facebook-square"><i classname="fab fa-instagram">
        </i></i></i></div><i classname="fab fa-twitter"><i classname="fab fa-facebook-square"><i classname="fab fa-instagram">
        );
        {'}'}
        {'}'});
